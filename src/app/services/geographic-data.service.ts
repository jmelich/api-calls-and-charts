      ...
      map(res => {
        ...
        return data.map( (entry: any) => {
          return {
            title: entry.title,
            quantities:{
              male: entry['cross:DataSet']['cross:Section']['cross:Obs'][0].OBS_VALUE,
              female: entry['cross:DataSet']['cross:Section']['cross:Obs'][1].OBS_VALUE,
              both: entry['cross:DataSet']['cross:Section']['cross:Obs'][2].OBS_VALUE
            }
          }
        });
      }),
